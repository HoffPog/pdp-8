...
REM
REM Generated by Vivado on Mon Nov 10 20:09:36 +0000 2025
...
echo "xvhdl --incr --relax -prj tb_program_counter_vhdl.prj"
call xvhdl  --incr --relax -prj tb_program_counter_vhdl.prj -log xvhdl.log
