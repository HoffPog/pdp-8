...
REM
REM Generated by Vivado on Mon Nov 10 23:08:02 +0000 2025
...
echo "xvhdl --incr --relax -prj memory_tb_vhdl.prj"
call xvhdl  --incr --relax -prj memory_tb_vhdl.prj -log xvhdl.log
