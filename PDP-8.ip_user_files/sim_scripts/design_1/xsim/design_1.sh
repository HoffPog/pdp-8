...
#
# Script generated by Vivado on Mon Nov 10 22:51:10 +0000 2025
...
export RDI_DATADIR="C:/Xilinx/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xlconstant_v1_1_10 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/2025.1/Vivado/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xlconstant_v1_1_10)
