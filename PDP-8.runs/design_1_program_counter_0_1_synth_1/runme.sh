...
HD_PWD='F:/UNI_STUFF/FPGA/PDP-8/PDP-8.runs/design_1_program_counter_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_program_counter_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_program_counter_0_1.tcl
